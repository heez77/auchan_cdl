...
import logging
import unidecode
from auchan_cdl.prediction.config import CFG
...
def preprocessing(df, texte):
    ...
    df_train.to_csv('/home/jeremy/Documents/GitHub/auchan_cdl/CamemBERT/Data/train.csv')
    df_val.to_csv('/home/jeremy/Documents/GitHub/auchan_cdl/CamemBERT/Data/val.csv')
    df_test.to_csv('/home/jeremy/Documents/GitHub/auchan_cdl/CamemBERT/Data/test.csv')
    df_lab.to_csv('/home/jeremy/Documents/GitHub/auchan_cdl/CamemBERT/Data/labels.csv', header=False, index=False)

def model():
    DATA_PATH = '/home/jeremy/Documents/GitHub/auchan_cdl/CamemBERT/Data/'
    OUTPUT_DIR = '/home/jeremy/Documents/GitHub/auchan_cdl/CamemBERT/Results'
...
def main():
    df = pd.read_csv('/home/jeremy/Documents/GitHub/auchan_cdl/CamemBERT/Data/text_detector_data.csv')
